...
-- Generation Time: Mar 15, 2023 at 10:53 PM
...
(42, 'w4angels-2023-03-03_20-45-01.jpg', '4angels', 'Keppel Center, Cardinal Rosales Ave, Cebu Business Park, Cebu City, 6000, Philippines', 123.909, 10.3183),
...
INSERT INTO `schedules` (`schedule_id`, `schedule_type`, `schedule_wage`) VALUES
('1', 0, 0),
('adwax', 0, 0),
('vg-100021', 1, 15),
('vg-100021230-0', 1, 15),
...
CREATE TABLE `schedule_assigns` (
  ...
  `schedule_assign_isComplete` int(11) NOT NULL,
  `schedule_assign_isRecordTimesheet` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `schedule_assigns` (`schedule_assigns_id`, `schedule_assigns_schedules_id`, `schedule_assigns_user_id`, `schedule_assign_tracker`, `schedule_assign_isComplete`, `schedule_assign_isRecordTimesheet`) VALUES
(2, '1', 10000038, 1, 0, 0),
(3, 'adwax', 10000038, 0, 0, 0);
...
CREATE TABLE `schedule_clock_event` (
  ...
  `clock_event_isclockin` tinyint(4) NOT NULL,
  `clock_event_intime` datetime NOT NULL,
  `clock_event_inlocation` varchar(255) NOT NULL,
  `clock_event_inlong` float NOT NULL,
  `clock_event_inlat` float NOT NULL,
  `clock_event_isclockout` tinyint(4) NOT NULL,
  `clock_event_outtime` datetime NOT NULL,
  `clock_event_outlocation` varchar(255) NOT NULL,
  `clock_event_outlong` float NOT NULL,
  `clock_event_outlat` float NOT NULL,
  `clock_event_schedule_assigns_id` int(11) NOT NULL,
  `clock_event_totalhour` float NOT NULL,
  `clock_event_totalwage` float NOT NULL,
  `clock_event_status` int(11) NOT NULL COMMENT '1 - undertime\r\n0 - complete\r\n2 - missing clockout\r\n3 - missing clockin\r\n4 - late'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `schedule_clock_event` (`clock_event_id`, `clock_event_user_id`, `clock_event_isclockin`, `clock_event_intime`, `clock_event_inlocation`, `clock_event_inlong`, `clock_event_inlat`, `clock_event_isclockout`, `clock_event_outtime`, `clock_event_outlocation`, `clock_event_outlong`, `clock_event_outlat`, `clock_event_schedule_assigns_id`, `clock_event_totalhour`, `clock_event_totalwage`, `clock_event_status`) VALUES
(8, 10000038, 1, '2023-03-15 02:00:00', '', 0, 0, 1, '2023-03-15 05:00:00', '', 0, 0, 2, 0, 0, 0),
(9, 10000038, 1, '2023-03-15 02:00:00', '', 0, 0, 0, '0000-00-00 00:00:00', '', 0, 0, 3, 0, 0, 0);
...
CREATE TABLE `schedule_details` (
  ...
  `schedule_detail_created_by` int(11) NOT NULL COMMENT 'created by must save a value of userid',
...
(1, 'Mang Limpyo ka ani orasa', 42, 3, '13:29:00', '23:12:04', 15, '2023-03-15', 10000000, '1'),
(3, 'manglaba', 42, 2, '20:20:36', '23:20:36', 15, '2023-03-15', 10000000, 'adwax'),
(5, NULL, 42, 1, '20:00:00', '21:00:00', 1, '2023-03-15', 2023, 'vg-100021230-0');
...
(10000000, 'w4angels-2023-03-13_20-41-44.jpeg', 'pro', 'weaver', '09614739205', '2023-03-04', 'proweaveradmin@gmail.com', '$2y$10$7F2ngdt4De5DBqAfITUtfu6/5O3qNIZPJwLagz.P6ChL9ppe9nsf2', 1, NULL, '0000-00-00', 1, '2023-03-03 00:25:50'),
(10000022, 'w4angels-2023-03-07_14-09-16.png', 'proweaver', 'supervisor', '', '0000-00-00', 'proweaversupervisor@gmail.com', '$2y$10$T7Sh25pFRbKeUHvPFyj1kOnqViE1ahHADlYVH/nInAa2sKoXJoMNK', 1, NULL, '0000-00-00', 2, '0000-00-00 00:00:00'),
(10000038, 'w4angels-2023-03-15_21-31-08.jpeg', 'John', 'Smith', '123123123', '2023-03-08', 'John099@gmail.com', '$2y$10$T5ajSD3G/2PEFO/nujdYYurDc51ITmIsCvo4h/fhcr9ZdyDBjhRna', 1, NULL, '2023-03-09', 0, '0000-00-00 00:00:00');
...
ALTER TABLE `schedule_clock_event`
  ...
  ADD KEY `clock_event_schedule_assigns_id` (`clock_event_schedule_assigns_id`);
...
--
ALTER TABLE `schedule_assigns`
  MODIFY `schedule_assigns_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `schedule_clock_event`
  MODIFY `clock_event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `schedule_details`
--
ALTER TABLE `schedule_details`
  MODIFY `schedule_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000039;
...
ALTER TABLE `schedule_clock_event`
  ...
  ADD CONSTRAINT `schedule_clock_event_ibfk_2` FOREIGN KEY (`clock_event_schedule_assigns_id`) REFERENCES `schedule_assigns` (`schedule_assigns_id`);
