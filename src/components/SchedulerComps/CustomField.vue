<template>
    <div class="pwbcf-custom-field">
        ...
        <div class="pwbcf-checkbox-group" :style="{'grid-template-columns':columns}" v-if="type == 'checkbox-group'">
            <label v-for="v,i in values" :key="i" :for="name+'_'+i">{{v.label}}
        ...
        <div class="pwbcf-select" :class="'pwbcf-select-'+name"  v-if="type == 'select'" @click="closeAllOpenSelects" :data-pwbcf="name">
            ...
            <div class="pwbcf-select-menu">
                <div :class="{active:valueC == v.value}" class="pwbcf-select-option" v-for="v,i in values" :key="i" @click="valueC = v.value;selectedValue = v.label">
                    {{v.label}}
                </div>
            </div>
        </div>
